 ...
 * @author Achyut
 */
public class BlackListCurrentReport extends javax.swing.JFrame {
    final Vector data = new Vector();
    final Vector columnNames = new Vector();
    /**
     * Creates new form BlackListCurrentReport
     */
    public BlackListCurrentReport() {
        getData();
        initComponents();
    ...
    private void getData(){
       ...
       // String query = "select * from blacklistcurrent";
        ...
        String query = "select  blacklistcurrentid as id,"
                         ...
                         +"reason  as reason from blacklistcurrent "
                         +"left join guest g "
        ...
        try {            
            ...
            columnNames.addElement("BLACK LISTED AT");
            columnNames.addElement("DURATION");
            columnNames.addElement("ADDED BY");
            ...
            int columns = md.getColumnCount();  
             ...
             //   System.out.print(rs.getString("checkincurrentid"));
                ...
                */
                ...
                String duration = rs.getString("day") + "Day "+ rs.getString("hour") +"Hours " +rs.getString("min")+" Min,"+rs.getString("sec")+"Sec";
            ...
            for(int i=1;i<=7;i++)
                //row.addElement("");
                     ...
                     Log.log.writeErrorLog(e.getMessage(),"Blacklistcurrentreport","getData");
        }
    }
    /**
    ...
    private void initComponents() {
        ...
        setTitle(": : Currently Blacklisted Report : :");
        setResizable(false);
        ...
        jLabel1.setText("Currently Blacklisted Students Report");
...
int key = evt.getKeyCode();
    ...
    private void jButton1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jButton1KeyPressed
        ...
        if (key == KeyEvent.VK_ENTER) {   
        Report r = new Report();
        r.BlacklistCurrentReport();// TODO add your handling code here:
        }if (key == KeyEvent.VK_ESCAPE) {   
        this.dispose();
        }
